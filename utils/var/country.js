...
export const countryCodeByName = (countryName) => {
	for (let country of countries) {
...
export const countryCode3ByName = (countryName) => {
  for (let country of countries) {
    if (country['label']==countryName) {
      let countryCode = country['value']
      for (let country2 of countryCodes) {
        if (country2[0]==countryCode) {
          return country2[1]
        }
      }
    }
...
export const statesByCountry = (country) => {
  for (let country_ of countryStates) {
    if (country==country_['code2']) {
