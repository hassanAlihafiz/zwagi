...
export default function CausesHtml(props) {
  ...
  const loadCause = (userType_) => {
    setIsLoading(true);
    callGetApi(`cause/1`, onGetCause, onFailCause);
  };
                    ...
                    >
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <img src="images/group19.jpg" alt="Hills" />
                        </div>
                        <div class="carousel-item">
                          <img src="images/group18.jpg" alt="Hills" />
                        </div>
                        <div class="carousel-item">
                          <img src="images/group17.jpg" alt="Hills" />
                        </div>
                        <div class="carousel-item">
                          <img src="images/group16.jpg" alt="Hills" />
                        </div>
                      </div>
                      <a
                      ...
                      <ol class="carousel-indicators list-inline">
                        ...
                        <li class="list-inline-item">
                          <a
                            ...
                            data-target="#custCarousel"
                          >
                            <img src="images/group18.jpg" class="img-fluid" />
                          </a>
                        </li>
                        <li class="list-inline-item">
                          <a
                            ...
                            data-target="#custCarousel"
                          >
                            <img src="images/group17.jpg" class="img-fluid" />
                          </a>
                        </li>
                        <li class="list-inline-item">
                          <a
                            ...
                            data-target="#custCarousel"
                          >
                            <img src="images/group16.jpg" class="img-fluid" />
                          </a>
                        </li>
                      </ol>
                    </div>
            ...
            <div class="col-lg-6">
              <div class="Every-slider3">
                ...
                <p style={{ display: "block" }}>
                  Every year millions of vulnerable people, mostly women and
                  children, are sexually exploited and trafficked. Our Partners
                  are leading the charge to end human trafficking by rescuing
                  victims, assisting law enforcement in the capture and
                  prosecution of the traffickers and empowering survivors to
                  regain their dignity on a path to a full, vibrant life. Join
                  us in supporting our Partners in this critical life or death
                  fight against the horrors of human trafficking.
                </p>
                {/* {isLoading ? (
                  <Spin />
                ) : (
          ...
          >
            <div class="cause-sectin">
              <img
                ...
                style={{ height: 295, width: "100%", objectFit: "cover" }}
              />
              <div class="cause-sectin-heading">
