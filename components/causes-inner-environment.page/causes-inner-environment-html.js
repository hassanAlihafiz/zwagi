...
export default function CausesHtml(props) {
  ...
  const loadCause = (userType_) => {
    setIsLoading(true);
    callGetApi(`cause/4`, onGetCause, onFailCause);
  };
                    ...
                    >
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <img src="images/group15.jpg" alt="Hills" />
                        </div>
                        <div class="carousel-item">
                          <img src="images/group14.jpg" alt="Hills" />
                        </div>
                        <div class="carousel-item">
                          <img src="images/group13.jpg" alt="Hills" />
                        </div>
                        <div class="carousel-item">
                          <img src="images/group12.jpg" alt="Hills" />
                        </div>
                      </div>
                      <a
                      ...
                      <ol class="carousel-indicators list-inline">
                        ...
                        <li class="list-inline-item">
                          <a
                            ...
                            data-target="#custCarousel"
                          >
                            <img src="images/group14.jpg" class="img-fluid" />
                          </a>
                        </li>
                        <li class="list-inline-item">
                          <a
                            ...
                            data-target="#custCarousel"
                          >
                            <img src="images/group13.jpg" class="img-fluid" />
                          </a>
                        </li>
                        <li class="list-inline-item">
                          <a
                            ...
                            data-target="#custCarousel"
                          >
                            <img src="images/group12.jpg" class="img-fluid" />
                          </a>
                        </li>
                      </ol>
                    </div>
            ...
            <div class="col-lg-6">
              <div class="Every-slider3">
                ...
                <p style={{ display: 'block'}}>
                  ...
                  future for our children. Join us in supporting organizations
                  that are leading the way in creating lasting solutions to some
                  of the biggest environmental challenges and in supporting
                  local farmers in the proliferation of sustainable and organic
                  growing practices to protect the independence of these
                  important growers while safeguarding our food system.
                </p>
                {/* {isLoading ? (
                  <Spin />
                ) : (
